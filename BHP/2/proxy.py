...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        if len(remote_buffer):
            ...
            # send the reponse to the local machine
            client_socket.send(remote_buffer)
...
def main():
    ...
    if len(sys.argv[1:]) != 5:
            print("Usage: python3 proxy.py [localhost] [localport] [remotehost] "
                "[remotepost] [recieve_first]")
            print("Example: python3 proxy.py 127.0.0.1 8080 10.12.142.1 9000 True")
            sys.exit(0)
    ...
    # this tells our porxy to connect and receive data
